                        ...
                        feature: {
                            ...
                            myTool1: {
                                ...
                                onclick: function (a, b, c, d) {
                                    ...
                                    for (var key in a.option.series) {




                                        a.option.series[key].label.show = true;
                                    }

                                    $(d.target).dispatchAction(a);


                                    console.log(a)
                                }
                                /*onclick: (option1)=>this.chart.setOption({
                                    series:[{label:{show:!option1.option.series[0].label.show}},{label:{show:!option1.option.series[1].label.show}},{label:{show:!option1.option.series[2].label.show}},{label:{show:!option1.option.series[3].label.show}},]
                                }),//先用这种方法凑合，下面的还没写好*/
                            },

                            // onclick:function(option1){
                            //     var newOption=option1.option.series;
                            //
                            //     //console.log(newOption);--------------------------------------------------------------待完成
                            //     for(var key in newOption)
                            //     {
                            //         newOption[key].label.show=!newOption[key].label.show;
                            //
                            //     }
                            //     option1.option.series=newOption;
                            //     var chart = document.getElementById('chart');
